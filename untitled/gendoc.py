...
doc.group_id=
# (非必填)是否动态根据分组id和请求路径更新文档 默认为false, 如果选择了代码块,则默认更新文档
doc.update=false
"""

plugin_info = """<?xml version="1.0" encoding="UTF-8"?>
<plugins>
    <plugin id="com.wangjin.Generate.WeimobDoc" url="https://file.javanet123.com/gen-doc-plugin-4.1.zip" version="4.1">
